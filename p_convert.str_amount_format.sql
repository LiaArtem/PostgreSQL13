...
AS $function$
DECLARE
    -- ѕреобразование суммы в текстовый формат числа
    p_n varchar(255);
    pos integer;
    p_num numeric;
...
BEGIN
    ...
    then
       RAISE EXCEPTION '%', ' оличество знаков после зап€той не может быль больше 5 или NULL !!!' USING ERRCODE = '45000';
    end if;
    ...
    -- восстанавливаем последнюю зап€тую
    pos := instr(p_n,' ',-1,1);
